...
\BITSetup{
  ...
  info = {
    ...
    % 如需要换行，则用 “\\” 符号分割。
    title = 基于智能手机摄像头的用户身份认证系统,
    titleEn = {User Identity Authentication System Based on Smartphone Camera},
    school = 计算机学院,
    major = 计算机科学与技术,
    class = 07111906,
    author = 钮海洋,
    studentId = 1120192605,
    supervisor = 李凡,
    keywords = {用户认证；心脏生物特征；摄像头 },
    keywordsEn = {user authentication; heart biometric feature; camera;},
